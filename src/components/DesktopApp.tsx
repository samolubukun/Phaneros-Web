...
const DesktopApp: React.FC<DesktopAppProps> = ({ onLinuxClick, onDownload, downloadUrl }) => {
  return (
      ...
      <div className="container" style={{ display: 'flex', gap: '4rem', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <div className="desktop-content" style={{ flex: '1 1 400px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            {/* Main Button */}
            <button onClick={() => onDownload(downloadUrl)} className="btn btn-primary main-download-btn" style={{ 
              gap: '1rem', 
              display: 'inline-flex', 
              alignItems: 'center',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                {/* Windows Icon */}
                <button onClick={() => onDownload(downloadUrl)} className="version-icon-btn" title="Windows">
                ...
                {/* Linux Icon */}
                <button onClick={onLinuxClick} className="version-icon-btn" title="Linux">
